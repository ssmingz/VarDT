 ...
 */
public class IFDSDataFlowAnalysis {
    ...
    public IFDSDataFlowAnalysis(String classpath, String processdir, String className, String methodName, List<String> paras, CompilationUnit cu) {
        _classpath = classpath;
        _process_dir = processdir;
        _className = className;
        _methodName = methodName;
        _methodParaTypes = new ArrayList<>(paras);
        _cu = cu;
    ...
    public void run(String classpath, String dir, String className, final String methodName, final List<String> paras){
        ...
        String javapath = "/mnt/hgfs/FaultLocalization/EXP/buggyProjects/math/math_25_buggy/aggre";
        String jredir = System.getProperty("java.home")+"/lib/rt.jar";
        String cp = javapath + File.pathSeparator + jredir;
        ...
        Options.v().set_main_class("org.apache.commons.math3.optimization.fitting.HarmonicFitterTest");
        SootClass c = Scene.v().loadClass("org.apache.commons.math3.optimization.fitting.HarmonicFitterTest", SootClass.BODIES);
        c.setApplicationClass();
        Scene.v().loadNecessaryClasses();
        SootMethod entryPoint = c.getMethodByName("testMath844");
        List<SootMethod> entryPoints = new ArrayList<SootMethod>();
        entryPoints.add(entryPoint);
        Scene.v().setEntryPoints(entryPoints);

        Transform t1 = new Transform("wjtp.herosifds", new SceneTransformer() {
            @Override
            protected void internalTransform(String s, Map<String, String> map) {
                // Heros IFDS/IDE frameword
                JimpleBasedInterproceduralCFG icfg = new JimpleBasedInterproceduralCFG();
                IFDSTabulationProblem<Unit, Pair<Value, Set<DefinitionStmt>>, SootMethod, InterproceduralCFG<Unit, SootMethod>> problem = new IFDSReachingDefinitions(icfg);
...
*/
            private boolean checkMethod(SootMethod method, String methodName, List<String> paras) {
                if(!method.getDeclaringClass().getName().equals(_className)) { return false; }
        ...
        PackManager.v().getPack("wjtp").add(new Transform("wjtp.herosifds", t1.getTransformer()));
        ...
        soot.Main.main(new String[]{
                "-process-dir", "/mnt/hgfs/FaultLocalization/EXP/buggyProjects/lang/lang_1_buggy/target",
                "-main-class", "org.apache.commons.lang3.math.NumberUtilsTest",
        ...
        /*
        soot.Main.main(new String[]{
                "-cp", "/mnt/hgfs/FaultLocalization/EXP/buggyProjects/lang/lang_1_buggy/target",
                "-process-dir", "/mnt/hgfs/FaultLocalization/EXP/buggyProjects/lang/lang_1_buggy/target",
                "-main-class", "org.apache.commons.lang3.math.NumberUtilsTest",
                "-pp", "-allow-phantom-refs",
                "--keep-line-number",
