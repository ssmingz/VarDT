...
public class SpectrumAnalysis {
    public static void main(String[] args) {
        ...
        for(String pro : pros) {
            ...
            //int[] bugs = {30};
            for(int j : bugs) {
                String values = String.format("/home/wymspace/collected_values/%s/%s_%d/original_delSpace.txt",pro,pro,j);
                String matrix = String.format("/home/wymspace/spectrum/%s/%s_%d",pro,pro,j);
